...
async def start(client, message):
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        await client.send_message(
            ...
            text="**You Are Not In Our Update Channel Given Below So You Don't Get The Movies File...\n\nIf You Want The File, Click On The '🤖 Join Updates Channel' Button Below And Join Our Update Channel, Then Click On The '🔄 Try Again' Button Below...\n\nThen You Will Get The Movies Files...**",
...
async def settings(client, message):
    ...
    if settings is not None:
        ...
        if chat_type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
            await message.reply_text(
                text="<b>Do You Want To Open Your Settings Here ?</b>",
                reply_markup=InlineKeyboardMarkup(btn),
        ...
        try:
            if REQST_CHANNEL is not None:
                btn = [[
                        ...
                        InlineKeyboardButton('Show Option', callback_data=f'show_option#{reporter}')
                      ]]
